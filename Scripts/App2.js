...
Office.initialize = function (reason) {
 ...
 //   if (Office.context) {
  //      Office.context.document.bindings.getByIdAsync('Locations', function (asyncResult) {
   //         
    //    }
  //  }
};
...
function setData(elementId) {
    ...
    Office.context.document.bindings.addFromSelectionAsync("text", { id: 'MyBinding2' }, 
        function (asyncResult) {
            appendMessage('Addeda neww binding with type: ' + asyncResult.value.type + ' and id: ' + asyncResult.value.id);
            asyncResult.value.setDataAsync("<img src=http://3.bp.blogspot.com/-vHo-JC9K1hk/UBeq58G_b9I/AAAAAAAAAKA/Ns-IN-Uqdow/s1600/2011-iihf-betting-canada.gif>",{coercionType: "html"});
            Office.select("bindings#MyBinding2").addHandlerAsync("bindingDataChanged", MyHandler2);
        }
    );
...
function MyHandler2(evt){
    appendMessage("image binding data changed");
}
